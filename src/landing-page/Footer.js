      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6">
        <div class="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          <div class="sm:col-span-12 lg:col-span-3">
            <div class="mb-10">
              <a
                href="/"
                class="flex order-first font-medium text-gray-900 lg:order-none lg:w-auto title-font"
              >
                <span class="text-xl font-black leading-none text-gray-900 select-none logo">
                  StyleSync<span class="text-blue-600">.</span>
                </span>
              </a>
            </div>
            <p
            ...
            >
              The StyleSync artificial intelligence will recommend clothes and
              accessories that are most likely to suit your style. Book an
              appointment now!
            </p>
          </div>
          <div class="sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h6 class="text-gray-900 font-bold mb-2 primary_text editable">
              Company
            </h6>
            <ul class="text-sm">
              <li class="mb-2">
                <a
                  class="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out secondary_text link-editable"
                  href="/"
                >
                  Home
                </a>
          ...
          <div class="sm:col-span-6 md:col-span-3 lg:col-span-3">
            ...
            <p class="text-sm text-gray-600 mb-4 secondary_text editable">
        ...
        <div class="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          <div class="text-sm text-gray-600 mr-4">
            © 2022 StyleSync. All rights reserved.
          </div>
        </div>
      </div>
    </div>
